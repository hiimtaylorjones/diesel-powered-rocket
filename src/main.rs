...
extern crate diesel_powered_rocket;
extern crate rocket;
...
use diesel::prelude::*;
use diesel_powered_rocket::*;
use diesel_powered_rocket::schema::posts;
...
fn main() {
    rocket::ignite().mount("/", routes![index, static_files::all]).launch();
}
